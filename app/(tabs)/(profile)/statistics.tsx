  ...
  useFocusEffect(
    useCallback(() => {
      ...
      const load = async () => {
        ...
        if (__DEV__) {
          console.log('[ProfileStatistics heatmap] sessions:', allSessions.length, 'exercises:', totalExercises, 'sets:', totalSets);
          const sample = allSessions[0];
          if (sample) console.log('[ProfileStatistics heatmap] sample:', { id: sample.id, date: sample.date, duration: sample.duration });
        }
