...
export default function ProfileScreen() {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      const load = async () => {
        ...
        // Load exercise favorites count for tile preview
        const exSettings = await getAllExerciseSettings();
        const favorites = Object.values(exSettings).filter((s) => s.favorite).length;
  ...
  const tiles: TileData[] = useMemo(
    () => [
      ...
      { id: 'exercises',   title: 'exercises.',  subtitle: `${EXERCISE_DATABASE.length} exercises`, route: '/exercises' },
  ...
  const renderItem = useCallback(
    ...
    [animTrigger, radarHeatmap, sessions, progressStats, activeDays, totalWorkouts, favCount],
  );
